...
## RL Training: Equalized Reward (UserRL-style F1 + constant turn reward)
#SBATCH --job-name="rl-equalized"
#SBATCH --account=pgs
#SBATCH --qos=low
...
echo "===== RL: Equalized Reward (F1 + 0.1/turn) ====="
...
# v2: epoch1 checkpoint (best val loss) + stronger KL + lower LR + higher turn reward
export BASE_MODEL='verl_checkpoints/sft-clarify-warmup/global_step_330'
export EXPERIMENT_NAME=rl-equalized-v2

...
## 2 卡：四分量全开 — F1 + adaptive_clarify + confidence + consistency
## 用法: sbatch train_clarify_full_2gpu.sh
#SBATCH --job-name="clarify-full-2gpu"
#SBATCH --account=pgs
#SBATCH --qos=low
...
echo "===== 2-GPU: Full Reward (F1 + clarify + confidence + consistency) ====="
...
export EXPERIMENT_NAME=clarify-full-2gpu

...
## RL Training: Adaptive Reward (existing main_ppo.py + stability fixes)
#SBATCH --job-name="rl-adaptive"
#SBATCH --account=pgs
#SBATCH --qos=low
...
echo "===== RL: Adaptive Reward (existing, + stability fixes) ====="
...
# v2: epoch1 checkpoint (best val loss) + stronger KL + lower LR
export BASE_MODEL='verl_checkpoints/sft-clarify-warmup/global_step_330'
export EXPERIMENT_NAME=rl-adaptive-v2
...
# ---------- Training (stability fixes: KL=0.03, lr=5e-7, warmup=0.2) ----------

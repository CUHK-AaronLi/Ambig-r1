...
export EXPERIMENT_NAME=abl-v8a-negig
...
echo "===== Ablation IG + v8a + Negative IG + F1 Floor (200 steps) ====="
echo "P0 changes from abl-v8a-200:"
echo "  1. Allow negative IG delta (clamp at -0.5 instead of 0.0)"
echo "  2. F1 floor = 0.1 (learn from clarify even on wrong answers)"
echo "Expected: model learns to NOT clarify when unnecessary -> clarify < 50%"
...
echo ""
echo "===== Ablation v8a + NegIG Results ====="

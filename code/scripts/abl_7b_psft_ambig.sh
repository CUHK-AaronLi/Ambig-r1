...
export EXPERIMENT_NAME=abl-7b-psft-ambig
...
echo "===== 7B PACIFIC-SFT cont: alpha=0.2 + ambiguity_penalty=0.1, push clarify ====="
echo "From: sft-7b-pacific/global_step_best (clean SFT start)"
echo "Goal: Ambiguity-aware reward to incentivize selective clarification"
...
echo ""
echo "===== 7B PACIFIC-SFT alpha=0.2 + ambiguity_penalty=0.1 Results ====="

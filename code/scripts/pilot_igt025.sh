...
export EXPERIMENT_NAME=pilot-igt025
...
echo "===== PILOT: IG Threshold = 0.25 (50 steps, 4 GPU) ====="
echo "delta must exceed 0.25 to get positive reward (p50 of distribution)"
echo "Expected: clarify rate ~25-35% action (~40-50% sample)"
...
echo ""
echo "===== Pilot IG Threshold 0.25 Results ====="
grep -E "val/f1|val/clarify|grad_norm" $EXPERIMENT_NAME.log | tail -20

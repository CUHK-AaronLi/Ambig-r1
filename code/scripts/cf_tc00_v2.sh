...
echo "===== CF turn_cost=0.00 v2 (OOM fix) on PACIFIC (100 steps, 8 GPU) ====="
...
export EXPERIMENT_NAME=cf-tc00-v2
...
# Re-run tc=0.0 with entropy OOM fix. Baseline for turn_cost ablation.
...
echo ""
echo "===== CF tc=0.00 v2 Results ====="
grep -E "val/f1|val/clarify" $EXPERIMENT_NAME.log | tail -20
echo ""

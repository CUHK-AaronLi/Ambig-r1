...
# Continue from 7605's step 120 checkpoint (F1=0.494, near peak)
export BASE_MODEL=/mnt/users_home/cpii.local/yli/Ambig-R1-new-claude/code/verl_checkpoints_diag/abl-v8a-7b-nothresh/actor/global_step_120
export VLLM_ATTENTION_BACKEND=XFORMERS
export WANDB_MODE=offline
export EXPERIMENT_NAME=abl-7b-cont100
...
echo "===== 7B Continue Training: 100 more steps from step 120 ====="
echo "Model: Qwen2.5-7B from abl-v8a-7b-nothresh/step_120"
echo "Goal: Improve no_clarify_f1 (currently 0.428) while keeping selective clarify"
echo "Reward: ablation IG, no threshold, alpha=0.1"
...
echo ""
echo "===== 7B Continuation Results ====="
grep -E "val/f1|val/post_clarify|val/no_clarify|val/clarify_rate|grad_norm" $EXPERIMENT_NAME.log | tail -30
echo ""

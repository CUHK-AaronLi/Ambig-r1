...
export EXPERIMENT_NAME=ar-best-200
...
echo "===== AutoResearch BEST: alpha=0.3, bonus=0.15, penalty=0.15 (200 steps) ====="
echo "From pilot 8090: F1=0.528, clarify=30.8%"

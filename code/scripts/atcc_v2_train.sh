...
hostname
echo "===== ATCC v2 Training: Negative Penalty for FACTUAL clarification ====="
...
# Start from ar-best-200 (PACIFIC-trained)
...
echo "Key change: factual_clarify_penalty=-0.10 (ACTIVE NEGATIVE PENALTY for FACTUAL)"
echo "Previous ATCC had zero bonus (insufficient), ATCC v2 has negative penalty"
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo_ipo \
    ...
    trainer.experiment_name=atcc-v2 \
    trainer.default_local_dir=/mnt/users_home/cpii.local/yli/Ambig-R1-new-claude/code/verl_checkpoints_diag/atcc-v2 \
    2>&1 | tee atcc-v2.log

echo ""
echo "===== ATCC v2 Training Complete ====="
echo "Done at: $(date)"

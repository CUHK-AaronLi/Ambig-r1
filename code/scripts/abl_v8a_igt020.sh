...
export EXPERIMENT_NAME=abl-v8a-igt020
...
echo "===== Ablation IG + v8a + IG Threshold 0.20 (200 steps, 8 GPU) ====="
echo "Validated in pilot: clarify ~37-41% (no lock), F1=0.521 at step 50"
echo "Full run target: F1 > 0.55, clarify < 45% action rate"
...
echo ""
echo "===== Ablation v8a IGT020 Results ====="

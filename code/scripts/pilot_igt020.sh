...
export EXPERIMENT_NAME=pilot-igt020
...
echo "===== PILOT: IG Threshold = 0.20 (50 steps, 4 GPU) ====="
echo "delta must exceed 0.20 to get positive reward (p25 of distribution)"
echo "Expected: clarify rate drops from 50% to ~20-25%"
...
echo ""
echo "===== Pilot IG Threshold 0.20 Results ====="

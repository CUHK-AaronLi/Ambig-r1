...
export EXPERIMENT_NAME=abl-7b-psft-clrbonus
...
echo "===== 7B PACIFIC-SFT cont: alpha=0.2 + clarify_bonus=0.1, push clarify ====="
...
echo ""
echo "===== 7B PACIFIC-SFT alpha=0.2 + clarify_bonus=0.1 Results ====="

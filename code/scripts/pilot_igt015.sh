...
export EXPERIMENT_NAME=pilot-igt015
...
echo "===== PILOT: IG Threshold = 0.15 (50 steps, 4 GPU) ====="
echo "delta must exceed 0.15 to get positive reward"
echo "Expected: clarify rate drops from 50% to ~30-35%"
...
echo ""
echo "===== Pilot IG Threshold 0.15 Results ====="

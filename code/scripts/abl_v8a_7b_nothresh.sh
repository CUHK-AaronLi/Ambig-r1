...
export EXPERIMENT_NAME=abl-v8a-7b-nothresh
...
echo "===== Ablation IG + v8a Config + Qwen2.5-7B — No threshold (200 steps) ====="
echo "Model: Qwen2.5-7B (SFT warmup best checkpoint)"
echo "Reward: ablation IG with P0 fixes + No threshold (ig_threshold=0.0)"
...
echo ""
echo "===== Ablation v8a 7B No Threshold Results ====="

...
# P0: Ablation IG (v8a config) + expandable_segments OOM fix
# This is the proven v8a recipe that hit F1=0.599 at 200+ steps
# With OOM fix, should be able to push further
...
echo ""
echo "===== Ablation IG 200-step Results ====="

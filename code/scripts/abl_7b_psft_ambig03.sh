...
export EXPERIMENT_NAME=abl-7b-psft-ambig03
...
echo "===== 7B PACIFIC-SFT cont: alpha=0.2 + ambiguity_penalty=0.3, push clarify ====="
...
echo ""
echo "===== 7B PACIFIC-SFT alpha=0.2 + ambiguity_penalty=0.3 Results ====="

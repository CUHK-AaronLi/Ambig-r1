...
export BASE_MODEL=/mnt/users_home/cpii.local/yli/Ambig-R1-new-claude/code/verl_checkpoints/sft-warmup-7b/global_step_best
export VLLM_ATTENTION_BACKEND=XFORMERS
export WANDB_MODE=offline
export EXPERIMENT_NAME=ar-7b-weak-best
...
echo "===== 7B Weak SFT + Best Reward (bonus=0.15, penalty=0.15, alpha=0.3) ====="
echo "Goal: Maintain 7B's natural 12.5% selective clarify + improve F1"
...
echo ""
echo "===== 7B Weak SFT Best Reward Results ====="
grep -E "val/f1|val/post_clarify|val/clarify_rate|val/no_clarify" $EXPERIMENT_NAME.log | tail -30

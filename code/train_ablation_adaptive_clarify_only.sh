...
## Ablation: adaptive_clarify only (关闭 confidence 和 consistency)
#SBATCH --job-name="ablation-adaptive-clarify-only"
#SBATCH --account=pgs
#SBATCH --qos=low
...
echo "===== Ablation: ADAPTIVE CLARIFY ONLY ====="
...
export EXPERIMENT_NAME=ablation-adaptive-clarify-only

...
export DATA_DIR='scripts/data_process/data/pacific'  # 修改：使用AmbigQA数据目录

WAND_PROJECT='Ambig-R1'  # 修改：项目名称改为Ambig-R1

# 模型选择 - 使用Qwen3-4B
export BASE_MODEL='Qwen/Qwen2.5-3B'  # 修改：使用4B模型
export EXPERIMENT_NAME=baseline-pacific-grpo-qwen2.5-3b-2  # 修改：实验名称

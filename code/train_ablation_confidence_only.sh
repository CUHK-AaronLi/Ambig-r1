...
## Ablation: confidence only (关闭 adaptive_clarify 和 consistency)
#SBATCH --job-name="ablation-confidence-only"
#SBATCH --account=pgs
#SBATCH --qos=low
...
export EXPERIMENT_NAME=ablation-confidence-only
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    +reward_weights.adaptive_clarify=0.0 \
    +reward_weights.confidence=0.1 \

...
## 2 卡主训练：Few-Shot + Adaptive Clarify（答错不罚 clarify，保守训练参数）
## 用法: sbatch train_clarify_2gpu.sh
#SBATCH --job-name="clarify-2gpu"
#SBATCH --account=pgs
#SBATCH --qos=low
...
echo "===== 2-GPU: Few-Shot + Adaptive Clarify (答错不罚) ====="
...
export EXPERIMENT_NAME=clarify-2gpu

...
## RL Training: Outcome-Only Reward (Pure F1 baseline)
#SBATCH --job-name="rl-outcome-only"
#SBATCH --account=pgs
#SBATCH --qos=low
...
echo "===== RL: Outcome-Only Reward (Pure F1) ====="
...
export EXPERIMENT_NAME=rl-outcome-only
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo_outcome_only \

...
## Ablation: confidence + adaptive_clarify (关闭 consistency)
#SBATCH --job-name="ablation-conf-clarify"
#SBATCH --account=pgs
#SBATCH --qos=low
...
echo "===== Ablation: CONFIDENCE + ADAPTIVE CLARIFY ====="
...
export EXPERIMENT_NAME=ablation-confidence-plus-clarify

...
echo "===== SOTA Push: Abg-CoQA 400-step FINAL — Beat 72.5 ====="
echo "NOTE: α=0.0 — Abg-CoQA has 0% clarify rate, no IG reward needed"
...
export DATA_DIR=scripts/data_process/data/abgcoqa
...
# ======================================================================
# CONFIGURE: Same winner model as PACIFIC 400-step
# ======================================================================
MODEL_TAG=${SOTA_MODEL:-3b}
...
export EXPERIMENT_NAME=sota-abgcoqa-400-${MODEL_TAG}
...
# Abg-CoQA: α=0.0 (no IG reward, clarify=0%)
...
echo ""
echo "===== Abg-CoQA 400-step Final Results ====="
echo "Target: val F1 > 0.725 (ACT trajectory similarity SOTA)"

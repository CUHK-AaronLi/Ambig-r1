...
export EXPERIMENT_NAME=ipo-v9a-pacific-searchfix
...
echo "===== IPO v9a: PACIFIC with SEARCH FIX + 400 steps ====="
echo "Purpose: Re-train PACIFIC after fixing search bug, with extended 400 steps"
echo "Change: (1) search actions receive real retrieval, (2) 400 steps (2x v8a)"
echo "Expected: F1 improvement from 0.599 → ~0.65+ (search + longer training)"

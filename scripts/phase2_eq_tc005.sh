...
export DATA_DIR=scripts/data_process/data/mixed
...
export EXPERIMENT_NAME=p2-eq-r003-tc005
...
echo "===== Phase 2A: Equalized reward=0.03, turn_cost=0.05 (mixed, 100 steps) ====="

PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo_equalized \
    data.train_files=$DATA_DIR/train.parquet \
    data.val_files=$DATA_DIR/val_mixed.parquet \
    ...
    +equalized.reward_per_turn=0.03 \
    +equalized.turn_cost=0.05 \
    +equalized.turn_cost_free=0 \

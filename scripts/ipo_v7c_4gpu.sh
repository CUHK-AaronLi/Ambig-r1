...
export EXPERIMENT_NAME=ipo-v7c-4gpu
...
echo "===== IPO v7c 4-GPU: Stronger reward shaping (alpha=0.2, baseline=0) ====="
echo "Purpose: 2x stronger IG shaping vs v7a — can it keep clarify >10% longer?"

...
echo "===== SOTA Push: PACIFIC 100-step diagnostic — Qwen2.5-3B-Instruct ====="
echo "Baseline: v8a PACIFIC F1=0.599 with same SFT checkpoint"
echo "Purpose: Fair 100-step comparison alongside 4B and 7B models"
...
export EXPERIMENT_NAME=sota-pacific-3b

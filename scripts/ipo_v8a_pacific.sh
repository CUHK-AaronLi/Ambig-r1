...
export EXPERIMENT_NAME=ipo-v8a-pacific
...
echo "===== IPO v8a: PACIFIC dataset, alpha=0.1, kl_coef=0.04, 200 steps ====="
echo "Purpose: Test IPO on PACIFIC (user reports better results) with reduced KL to prevent NaN"

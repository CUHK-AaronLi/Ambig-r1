...
export EXPERIMENT_NAME=ipo-v8i-pacific-alpha020
...
echo "===== IPO v8i: PACIFIC dataset, alpha=0.2, kl_coef=0.04, 200 steps ====="
echo "Purpose: Alpha sensitivity ablation — higher IG weight (0.2 vs default 0.1)"

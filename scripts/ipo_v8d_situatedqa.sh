...
export EXPERIMENT_NAME=ipo-v8d-situatedqa
...
echo "===== IPO v8d: SituatedQA dataset, alpha=0.1, kl_coef=0.04, 200 steps ====="
echo "Purpose: Test IPO on SituatedQA (temporal/geographical ambiguity, 43% ambiguous)"

...
export EXPERIMENT_NAME=ipo-v8b-abgcoqa
...
echo "===== IPO v8b: AbgCoQA dataset, alpha=0.1, kl_coef=0.04, 200 steps ====="
echo "Purpose: Test IPO on AbgCoQA with reduced KL to prevent NaN"

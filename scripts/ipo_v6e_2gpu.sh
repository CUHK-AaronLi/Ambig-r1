...
export EXPERIMENT_NAME=ipo-v6e-2gpu
...
echo "===== IPO v6e: New simulator + alpha=0.5 (no bonus, pure IG) ====="
echo "Purpose: Stronger IG weight with new quality simulator"

...
echo "===== EXP2: Best config on AmbigNQ (200 steps) ====="
...
export EXPERIMENT_NAME=exp2-ambignq-200
...
# AmbigNQ: use test.parquet as val (no separate validation split)

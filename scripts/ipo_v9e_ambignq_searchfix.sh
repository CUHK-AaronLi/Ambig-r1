...
export EXPERIMENT_NAME=ipo-v9e-ambignq-searchfix
...
echo "===== IPO v9e: AmbigNQ with SEARCH FIX ====="
echo "Purpose: Re-train AmbigNQ after fixing search bug (do_search=True in generation.py)"
echo "Change: search actions now receive real retrieval results during training"
echo "Expected: F1 improvement from 0.166 → ~0.30+ (gold passage ceiling: 0.344)"

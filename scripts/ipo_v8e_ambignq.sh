...
export EXPERIMENT_NAME=ipo-v8e-ambignq
...
echo "===== IPO v8e: AmbigNQ dataset, alpha=0.1, kl_coef=0.04, 200 steps ====="
echo "Purpose: AmbigNQ with v8 config for 5-dataset cross-comparison"

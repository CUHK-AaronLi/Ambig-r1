...
export EXPERIMENT_NAME=p2-eq-r005-tc000
...
echo "===== Phase 2B: Equalized reward=0.05, turn_cost=0 (mixed, 100 steps) ====="
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo_equalized \
    ...
    +equalized.reward_per_turn=0.05 \
    +equalized.turn_cost=0 \

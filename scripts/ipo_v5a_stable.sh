...
export EXPERIMENT_NAME=ipo-v5a-stable
...
echo "===== IPO v5a: Stable (no ablation, no efficiency bonus, alpha=0.3, tc=0.05) ====="
echo "Key changes vs v4: efficiency_bonus=0 (was 0.15), enable_ablation=false, alpha=0.3 (was 0.5)"

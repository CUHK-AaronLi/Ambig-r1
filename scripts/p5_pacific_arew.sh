...
echo "===== P5: PACIFIC + AReW Critique (100 steps) ====="
echo "NOTE: p0-simfix F1=0.532 at step 100. v8a peak F1=0.599."
echo "      AReW should improve clarify quality → higher F1."
...
export EXPERIMENT_NAME=p5-pacific-arew
...
# PACIFIC: clarify ENABLED, search DISABLED, + AReW critique
# Compared to p0-simfix (no AReW): expect higher clarify quality → better F1
...
echo ""
echo "===== PACIFIC + AReW Results ====="
echo "Compare with:"
echo "  p0-simfix (no AReW): F1=0.532 at step 100"
echo "  v8a (200+ steps, no AReW): F1=0.599"
echo "  Expected: F1 > 0.532 at step 100 (better clarify quality)"

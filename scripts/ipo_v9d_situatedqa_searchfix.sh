...
export EXPERIMENT_NAME=ipo-v9d-situatedqa-searchfix
...
echo "===== IPO v9d: SituatedQA with SEARCH FIX + turn_cost ====="
echo "Purpose: Re-train SituatedQA after fixing search bug + add turn_cost=0.01"
echo "Change: (1) search actions receive real retrieval, (2) gentle turn_cost to curb over-clarify"
echo "Expected: F1 improvement from 0.295 → ~0.32+ (less wasted turns + useful retrieval)"

...
export EXPERIMENT_NAME=ipo-v8h-pacific-alpha005
...
echo "===== IPO v8h: PACIFIC dataset, alpha=0.05, kl_coef=0.04, 200 steps ====="
echo "Purpose: Alpha sensitivity ablation — lower IG weight (0.05 vs default 0.1)"

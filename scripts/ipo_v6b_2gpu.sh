...
export EXPERIMENT_NAME=ipo-v6b-2gpu
...
echo "===== IPO v6b: Medium bonus (clarify_bonus=0.10, turn_cost=0.05) ====="
echo "Purpose: Test moderate clarify incentive"

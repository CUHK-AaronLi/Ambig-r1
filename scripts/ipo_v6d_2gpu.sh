...
export EXPERIMENT_NAME=ipo-v6d-2gpu
...
echo "===== IPO v6d: Bonus without turn_cost (clarify_bonus=0.10, turn_cost=0.00) ====="
echo "Purpose: Isolate turn_cost effect (compare with v6b)"

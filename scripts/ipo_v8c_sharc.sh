...
export EXPERIMENT_NAME=ipo-v8c-sharc
...
echo "===== IPO v8c: ShARC dataset, alpha=0.1, kl_coef=0.04, 200 steps ====="
echo "Purpose: Test IPO on ShARC (rule-based clarification, 31% Inquire rate)"

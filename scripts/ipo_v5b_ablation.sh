...
export EXPERIMENT_NAME=ipo-v5b-ablation
...
echo "===== IPO v5b: Ablation (keep counterfactual, no efficiency bonus, alpha=0.3, tc=0.03) ====="
echo "Key changes vs v4: efficiency_bonus=0, alpha=0.3 (was 0.5), baseline_reward=0.03 (was 0.05)"

...
export EXPERIMENT_NAME=ipo-v7a-4gpu
...
echo "===== IPO v7a 4-GPU: Reward shaping (alpha=0.1, baseline=0, outcome-gated IG) ====="
echo "Purpose: IG only fires when F1>0, small shaping signal for credit assignment"

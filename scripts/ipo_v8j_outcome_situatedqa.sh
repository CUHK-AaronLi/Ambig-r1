...
export EXPERIMENT_NAME=ipo-v8j-outcome-situatedqa
...
echo "===== IPO v8j: SituatedQA Outcome-Only (alpha=0.0), 200 steps ====="
echo "Purpose: Test if SituatedQA's 91% clarify rate is dataset-driven or IG-driven"
echo "If outcome-only also shows ~91% clarify → dataset property"
echo "If outcome-only shows collapse → IG reward is necessary for SituatedQA"

...
export EXPERIMENT_NAME=ipo-v6a-2gpu
...
echo "===== IPO v6a: New simulator control (clarify_bonus=0, turn_cost=0.05) ====="
echo "Purpose: Isolate new simulator effect vs v5a"

...
echo "===== P0 Verification: PACIFIC 100-step with FIXED simulator metadata ====="
echo "NOTE: This verifies that PACIFIC 'sustained co-optimization' holds after fixing"
echo "      the simulator metadata (adding clarify_context + data_source to extra_info)"
...
# Step 1: Regenerate PACIFIC data with fixed metadata
echo "Regenerating PACIFIC data with fixed simulator metadata..."
python3 scripts/data_process/pacific.py 2>&1 | tail -5
...
export EXPERIMENT_NAME=p0-pacific-simfix
...
echo ""
echo "===== P0 Verification Results ====="
echo "Compare with original PACIFIC (v8a step 100: F1~0.508, clarify~50.5%)"

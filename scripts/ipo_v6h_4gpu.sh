...
export EXPERIMENT_NAME=ipo-v6h-4gpu
...
echo "===== IPO v6h 4-GPU: Clarify warm-up (turn_cost=0, bonus=0.05, alpha=0.7) ====="
echo "Purpose: Phase 1 curriculum — encourage clarify, then Phase 2 from checkpoint with turn_cost=0.05"

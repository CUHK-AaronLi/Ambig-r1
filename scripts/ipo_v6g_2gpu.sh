...
export EXPERIMENT_NAME=ipo-v6g-2gpu
...
echo "===== IPO v6g: New simulator + alpha=1.0 (no bonus, max IG, diagnostic) ====="
echo "Purpose: Maximum IG weight — upper bound for natural clarify learning"

...
export EXPERIMENT_NAME=ipo-v7d-4gpu
...
echo "===== IPO v7d 4-GPU: v7a config + NaN protection + 300 steps ====="
echo "Purpose: Same as v7a (alpha=0.1) but with NaN grad skip + longer training"

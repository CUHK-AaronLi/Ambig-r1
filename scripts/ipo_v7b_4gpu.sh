...
export EXPERIMENT_NAME=ipo-v7b-4gpu
...
echo "===== IPO v7b 4-GPU: Outcome-only (pure F1, no IG reward) ====="
echo "Purpose: Baseline — does the model learn clarify from F1 signal alone?"

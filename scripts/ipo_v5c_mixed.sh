...
export EXPERIMENT_NAME=ipo-v5c-mixed
...
echo "===== IPO v5c: Mixed data (no ablation, no efficiency bonus, alpha=0.3, tc=0.05) ====="
echo "Same as v5a but with mixed data (AmbigNQ + AbgCoQA + PACIFIC)"

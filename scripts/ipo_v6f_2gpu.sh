...
export EXPERIMENT_NAME=ipo-v6f-2gpu
...
echo "===== IPO v6f: New simulator + alpha=0.7 (no bonus, strong IG) ====="
echo "Purpose: Strong IG weight — does higher alpha prevent clarify collapse?"
